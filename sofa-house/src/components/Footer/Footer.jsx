      ...
      <div className="footer-content">
        <div className="footer-content-column">
          ...
          <div className="footer-menu">
            <h2 className="footer-menu-name"> Sofa's</h2>
            <ul id="menu-get-started" className="footer-menu-list">
              <li id="menu-item-173730" className="menu-item menu-item-type-post_type menu-item-object-product menu-item-173730">
                <a href="#">single seat</a>
              </li>
              <li id="menu-item-173728" className="menu-item menu-item-type-post_type menu-item-object-product menu-item-173728">
                <a href="#">double seat</a>
              </li>
              <li id="menu-item-173727" className="menu-item menu-item-type-post_type menu-item-object-product menu-item-173727">
                <a href="#">thriple seat</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="footer-content-column">
          <div className="footer-menu">
            ...
            <ul id="menu-company" className="footer-menu-list">
              <li id="menu-item-167408" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-167408">
                <a href="#">Contact</a>
              </li>
              <li id="menu-item-167409" className="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-167409">
                <a href="#">News</a>
              </li>
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            ...
            <ul id="menu-quick-links" className="footer-menu-list">
              ...
              <li id="menu-item-167955" className="menu-item menu-item-type-post_type_archive menu-item-object-customer menu-item-167955"><a href="#">Customers</a></li>
        ...
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            ...
            <p className="footer-call-to-action-description"> Have a support question? Want to add SMS to your app? Need to talk to legal? Have a great minestrone soup recipe? Whatever the reason you need to chat, let us know and we'll give you a call.</p>
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="#" target="_self"> ©2020. | Pooja Nahelia. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
